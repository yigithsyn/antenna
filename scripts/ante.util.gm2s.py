...
# implementation
gmml = numpy.power(10,numpy.asarray(getattr(args,"gamma"),dtype="float")/20) if getattr(args,"db") else numpy.asarray(getattr(args,"gamma"),dtype="float") 
numpy.savetxt(sys.stdout,(1+gmml)/(1-gmml),fmt='%.3G')
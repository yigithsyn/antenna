...
pars = ArgumentParser(prog="ante.util.gm2s", description="reflection coefficient (gamma) to voltage standing wave ratio (vswr) conversion", formatter_class=RawDescriptionHelpFormatter, epilog="\n\nformula:\n  SWR &= \\dfrac{1+|\\Gamma|}{1-|\\Gamma|}\n\n\n\nauthor(s):\n  Huseyin YIGIT, yigit.hsyn@gmail.com")
